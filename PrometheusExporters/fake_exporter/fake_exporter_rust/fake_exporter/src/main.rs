...
use std::{net::Ipv4Addr, net::SocketAddr, sync::Mutex};
...
fn compute_labels(num_labels: usize, num_values_per_label: Vec<usize>) -> Vec<Vec<String>> {
...
struct Args {
    ...
    #[arg(long, help = "Dataset type (uniform, normal, zipf, dynamic)")]
    dataset: String,
